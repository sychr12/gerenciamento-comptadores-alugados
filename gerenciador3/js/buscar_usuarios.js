            ...
            dados.forEach(usuario => {
                ...
                row.innerHTML = `
                    <div class="perfil-container">
                        <img src="/gerenciador3/imagens/default.png" alt="foto de perfil" class="perfil-foto"/>
                    </div>
                    <p>${usuario.id}</p>
                    <p>${usuario.nome}</p>
                    <p>${usuario.cargo}</p>
                    ...
                    <p class="p-btn">
                        ...
                        <img src="/gerenciador3/imagens/ferramenta-lapis.png" alt="btn-edita" class="btn-editar"/>
                        </button>

                        <button class="btn-excluir">
                         <img src="/gerenciador3/imagens/lata-de-lixo.png" alt="btn-excluir" class="btn-excluir"/>
                         </button>
                        </button>
                    </p>
                `;
